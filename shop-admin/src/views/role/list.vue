<template>
    <div>
            ...
            <el-table :data="tableData" stripe style="width: 100%">
                ...
                <el-table-column prop="desc" label="状态">
                    <template #default="{row}">
                        <el-switch v-model="row.status" :active-value="1" :inactive-value="0" @change="amendAdminStatus($event,row)">
                        </el-switch>
                    </template>
                </el-table-column>
        ...
        <!-- 权限弹窗 -->
        <ZDrawer :loading="treeLoading"  destroyOnClose ref="roleDrawerRef" title="权限配置"
            @onSubmit="onRoleSubmit" @cancel="Rolecancel">
            <el-tree-v2
            ref="treeRef"
             node-key="id"
            :data="treeList"
