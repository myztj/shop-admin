        ...
        <el-card shadow="never">
            <template #header>
                ...
                <div>
                        ...
                        <template #show>
                            <SearchItem label="商品分类">
                                <el-select v-model="searchForm.category_id" placeholder="请选者商品分类" clearable>
                                    <el-option v-for="item in catesList" :key="item.id" :label="item.name"
                                        :value="item.id">
                                    </el-option>
                                </el-select>
                            </SearchItem>
                    ...
                    <!-- 新增|刷新 -->
                    <ListHeader delete_all @added="added" @delete_all="handelDelete_all" @refreshList="getTableData">
                        <el-button size="small" @click="handelUpdateStatus(1)">上架</el-button>
                        <el-button size="small" @click="handelUpdateStatus(0)">下架</el-button>
                    </ListHeader>
                </div>
            </template>
                ...
                <el-table-column label="操作">
                    <template #default="{row}">
                        <div v-if="searchForm.tab!='delete'">
                            <el-button class="ml-0" type="primary" size="small" text @click="amend(row)">修改</el-button>
                            <el-button type="primary" size="small" text>商品规格</el-button>
                            <el-button :type="row.goods_banner.length>0?'primary':'danger'" size="small" text @click="openSetBanner(row)">设置轮播图</el-button>
                            <el-button type="primary" size="small" text @click="goodsDetails(row)">商品详情</el-button>
